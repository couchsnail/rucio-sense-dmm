...
from dmm.utils.db import get_site, get_all_endpoints, get_endpoint, check_endpoint_truly_in_use
...
def refresh_site_db(certs=None, session=None):
    ...
    for site in sites.split(","):
        ...
        # check for any new endpoints that might have been added to siterm
...
def free_unused_endpoints(session=None):
    ...
    for endpoint in endpoints:
        truly_in_use = check_endpoint_truly_in_use(endpoint, session=session)
